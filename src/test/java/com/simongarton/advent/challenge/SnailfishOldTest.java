...
class SnailfishOldTest {
    ...
    void testToString() {
        ...
        // when
        final SnailfishOld snailfish = new SnailfishOld(line);
    ...
    void explode(final String line, final String expected) {
        ...
        // when
        final SnailfishOld exploded = SnailfishOld.explode(snailfish);
    ...
    void add() {
        // given
        final SnailfishOld one = new SnailfishOld("[1,2]");
        final SnailfishOld two = new SnailfishOld("[[3,4],5]");

        // when
        final SnailfishOld three = one.add(two);
    ...
    void findNumberStartingAtIndexAndGoingBackwards(final String line, final int index, final int expected) {
        ...
        // when
        final SnailfishOld.StringReference stringReference = SnailfishOld.findNumberStartingAtIndexAndGoingBackwards(line, index);
    ...
    void findNumberStartingAtIndexAndGoingForwards(final String line, final int index, final int expected) {
        ...
        // when
        final SnailfishOld.StringReference stringReference = SnailfishOld.findNumberStartingAtIndexAndGoingForwards(line, index);
